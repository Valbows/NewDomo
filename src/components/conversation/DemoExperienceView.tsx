  ...
  function DemoExperienceView(
    ...
    const handleToolCall = useCallback(
      async (toolName: string, args: any) => {
        console.log(`🔧 DemoExperienceView tool call: ${toolName}`, args);
        ...
        if (toolName === 'fetch_video') {
          ...
          console.log(`🎬 Fetching video: "${normalizedTitle}"`);
          ...
          console.log('✅ Playing video:', videoData.title, signedUrlData.signedUrl);
        ...
        if (toolName === 'show_trial_cta' || toolName === 'show_cta') {
          console.log('🎯 Show CTA requested');
          setShowCTA(true);
        ...
        console.log(`⚠️ Unknown tool call: ${toolName}`);
        onToolCall({ name: toolName, args });
      },
