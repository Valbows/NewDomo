    ...
    <section className="bg-white py-20 sm:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-domo-blue-accent">Core Features</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-domo-dark-text sm:text-4xl">
            Everything you need for engaging product demos
          </p>
          <p className="mt-6 text-lg leading-8 text-domo-light-text">
          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3 lg:gap-y-16">
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-16">
                <dt className="text-base font-semibold leading-7 text-domo-dark-text">
                  <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-domo-blue-accent">
                    <feature.icon className="h-6 w-6 text-white" aria-hidden="true" />
                  </div>
                  {feature.name}
                </dt>
                <dd className="mt-2 text-base leading-7 text-domo-light-text">{feature.description}</dd>
              </div>
            ))}
          </dl>
        </div>
