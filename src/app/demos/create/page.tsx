  ...
  return (
    <DashboardLayout>
      <div className="max-w-2xl mx-auto py-10">
        <h1 className="text-3xl font-bold text-domo-dark-text mb-2">
          Create a New Demo
        </h1>
        <p className="text-domo-light-text mb-8">
          Give your demo a name to get started. You'll upload videos and
          configure your agent in the next step.
        </p>
        ...
        >
          <div>
            <label
              htmlFor="demoName"
              className="block text-sm font-medium text-domo-dark-text"
            >
              Demo Name
            </label>
            <input
